...
var of = 0
var dragging
@onready var light_controls = get_tree().get_root().get_node("Main/Control/RightPanel/Properties/VSplitContainer/ScrollContainer/Misc/ScrollContainer5/VBoxContainer/HBox25")
